...
class CustomSsoSecurityManager(SupersetSecurityManager):
    def oauth_user_info(self, provider, response=None):
        ...
        if provider == 'awscognito':
            ...
            user_info_url = f"https://stevetest.auth.us-east-1.amazoncognito.com/oauth2/userInfo"
            ...
            if user_info_response.status_code == 200:
                ...
                logging.error("Failed to get user info: {0} - {1}".format(user_info_response.status_code, user_info_response.text))
                return None
